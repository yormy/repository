...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
          { text: 'Home', link: '/' },
          { text: 'Guide', link: '/v1/introduction/what-is-repository' },
        ],
        ...
        sidebar: [
            {
                text: 'Introduction',
                items: [
                    { text: 'What is Guidelines', link: '/v1/introduction/what-is-repository' },
                ]
            },
        ...
        socialLinks: [
            { icon: 'github', link: 'https://github.com/yormy/repository' }
        ]
      }
